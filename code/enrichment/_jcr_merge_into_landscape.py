...
bj  = pd.read_csv("data/journals/07_24_2026_journal_landscape_by_journal.csv", dtype=str, keep_default_na=False, na_filter=False)
bp  = pd.read_csv("data/journals/07_24_2026_journal_landscape_by_paper.csv",   dtype=str, keep_default_na=False, na_filter=False)
...
bj = bj[cols]
bj.to_csv("data/journals/07_25_2026_journal_landscape_by_journal_JCR.csv", index=False)
...
bp.to_csv("data/journals/07_25_2026_journal_landscape_by_paper_JCR.csv", index=False)
