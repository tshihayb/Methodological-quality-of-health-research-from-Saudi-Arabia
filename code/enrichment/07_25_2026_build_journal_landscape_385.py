...
than guessed.
  ...
  identity + indexing (PubMed/NLM) : data/journals/07_25_2026_journal_pubmed_metadata_385.csv
  SJR quartile + categories (SCImago 2022) : data/journals/07_24_2026_scimago_2022_raw.csv
  topic + open-access + DOAJ (OpenAlex) : data/journals/07_25_2026_openalex_works_385.json
...
meta = pd.read_csv(PROJ + r"\07_25_2026_journal_pubmed_metadata_385.csv", dtype=str).fillna("")
sj   = pd.read_csv(PROJ + r"\07_24_2026_scimago_2022_raw.csv", dtype=str).fillna("")
oa   = json.load(open(PROJ + r"\07_25_2026_openalex_works_385.json", encoding="utf-8"))
...
paper.to_csv(PROJ + r"\07_25_2026_journal_landscape_by_paper_385.csv", index=False, encoding="utf-8")
...
jour.to_csv(PROJ + r"\07_25_2026_journal_landscape_by_journal_385.csv", index=False, encoding="utf-8")
